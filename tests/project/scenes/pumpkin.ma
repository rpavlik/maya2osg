...
//Name: pumpkin.ma
//Last modified: Wed, Nov 03, 2010 06:05:57 PM
//Codeset: 1252
requires maya "2010";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.5616617287044621 0.86612135858999784 0.52233311886105094 ;
	setAttr ".r" -type "double3" -16.538352730378023 1364.5999999997446 -6.3088879657685259e-015 ;
...
createNode psdFileTex -n "PSD_lambert_pumpkin_color";
	...
	setAttr ".lsn" -type "string" "lambert_pumpkin.color";
createNode place2dTexture -n "place2dTexture1";
createNode psdFileTex -n "PSD_lambert_pumpkin_transparency";
	setAttr ".ftn" -type "string" "C:/Users/jtaibo/Documents/My Dropbox/Bixorama/proyecto_maya//sourceimages/pumpkin_pSphereShape1.psd";
	setAttr ".lsn" -type "string" "lambert_pumpkin.transparency";
createNode place2dTexture -n "place2dTexture2";
createNode psdFileTex -n "PSD_lambert_pumpkin_incandescence";
	setAttr ".ftn" -type "string" "C:/Users/jtaibo/Documents/My Dropbox/Bixorama/proyecto_maya//sourceimages/pumpkin_pSphereShape1.psd";
	setAttr ".lsn" -type "string" "lambert_pumpkin.incandescence";
...
createNode psdFileTex -n "PSD_lambert_pumpkin_ambientColor";
	setAttr ".ftn" -type "string" "C:/Users/jtaibo/Documents/My Dropbox/Bixorama/proyecto_maya//sourceimages/pumpkin_pSphereShape1.psd";
	setAttr ".lsn" -type "string" "lambert_pumpkin.ambientColor";
createNode place2dTexture -n "place2dTexture5";
createNode psdFileTex -n "PSD_lambert_pumpkin_diffuse";
	setAttr ".ail" yes;
	setAttr ".ftn" -type "string" "C:/Users/jtaibo/Documents/My Dropbox/Bixorama/proyecto_maya//sourceimages/pumpkin_pSphereShape1.psd";
	setAttr ".lsn" -type "string" "lambert_pumpkin.diffuse";
...
connectAttr "PSD_lambert_pumpkin_color.oc" "lambert_pumpkin.c";
connectAttr "PSD_lambert_pumpkin_transparency.oc" "lambert_pumpkin.it";
connectAttr "PSD_lambert_pumpkin_incandescence.oc" "lambert_pumpkin.ic";
connectAttr "bump2d1.o" "lambert_pumpkin.n";
connectAttr "PSD_lambert_pumpkin_ambientColor.oc" "lambert_pumpkin.ambc";
connectAttr "PSD_lambert_pumpkin_diffuse.oa" "lambert_pumpkin.dc";
...
connectAttr "PSD_lambert_pumpkin_color.msg" "materialInfo1.t" -na;
...
connectAttr "place2dTexture1.c" "PSD_lambert_pumpkin_color.c";
connectAttr "place2dTexture1.tf" "PSD_lambert_pumpkin_color.tf";
connectAttr "place2dTexture1.rf" "PSD_lambert_pumpkin_color.rf";
connectAttr "place2dTexture1.mu" "PSD_lambert_pumpkin_color.mu";
connectAttr "place2dTexture1.mv" "PSD_lambert_pumpkin_color.mv";
connectAttr "place2dTexture1.s" "PSD_lambert_pumpkin_color.s";
connectAttr "place2dTexture1.wu" "PSD_lambert_pumpkin_color.wu";
connectAttr "place2dTexture1.wv" "PSD_lambert_pumpkin_color.wv";
connectAttr "place2dTexture1.re" "PSD_lambert_pumpkin_color.re";
connectAttr "place2dTexture1.of" "PSD_lambert_pumpkin_color.of";
connectAttr "place2dTexture1.r" "PSD_lambert_pumpkin_color.ro";
connectAttr "place2dTexture1.n" "PSD_lambert_pumpkin_color.n";
connectAttr "place2dTexture1.vt1" "PSD_lambert_pumpkin_color.vt1";
connectAttr "place2dTexture1.vt2" "PSD_lambert_pumpkin_color.vt2";
connectAttr "place2dTexture1.vt3" "PSD_lambert_pumpkin_color.vt3";
connectAttr "place2dTexture1.vc1" "PSD_lambert_pumpkin_color.vc1";
connectAttr "place2dTexture1.o" "PSD_lambert_pumpkin_color.uv";
connectAttr "place2dTexture1.ofs" "PSD_lambert_pumpkin_color.fs";
connectAttr "place2dTexture2.c" "PSD_lambert_pumpkin_transparency.c";
connectAttr "place2dTexture2.tf" "PSD_lambert_pumpkin_transparency.tf";
connectAttr "place2dTexture2.rf" "PSD_lambert_pumpkin_transparency.rf";
connectAttr "place2dTexture2.mu" "PSD_lambert_pumpkin_transparency.mu";
connectAttr "place2dTexture2.mv" "PSD_lambert_pumpkin_transparency.mv";
connectAttr "place2dTexture2.s" "PSD_lambert_pumpkin_transparency.s";
connectAttr "place2dTexture2.wu" "PSD_lambert_pumpkin_transparency.wu";
connectAttr "place2dTexture2.wv" "PSD_lambert_pumpkin_transparency.wv";
connectAttr "place2dTexture2.re" "PSD_lambert_pumpkin_transparency.re";
connectAttr "place2dTexture2.of" "PSD_lambert_pumpkin_transparency.of";
connectAttr "place2dTexture2.r" "PSD_lambert_pumpkin_transparency.ro";
connectAttr "place2dTexture2.n" "PSD_lambert_pumpkin_transparency.n";
connectAttr "place2dTexture2.vt1" "PSD_lambert_pumpkin_transparency.vt1";
connectAttr "place2dTexture2.vt2" "PSD_lambert_pumpkin_transparency.vt2";
connectAttr "place2dTexture2.vt3" "PSD_lambert_pumpkin_transparency.vt3";
connectAttr "place2dTexture2.vc1" "PSD_lambert_pumpkin_transparency.vc1";
connectAttr "place2dTexture2.o" "PSD_lambert_pumpkin_transparency.uv";
connectAttr "place2dTexture2.ofs" "PSD_lambert_pumpkin_transparency.fs";
connectAttr "place2dTexture3.c" "PSD_lambert_pumpkin_incandescence.c";
connectAttr "place2dTexture3.tf" "PSD_lambert_pumpkin_incandescence.tf";
connectAttr "place2dTexture3.rf" "PSD_lambert_pumpkin_incandescence.rf";
connectAttr "place2dTexture3.mu" "PSD_lambert_pumpkin_incandescence.mu";
connectAttr "place2dTexture3.mv" "PSD_lambert_pumpkin_incandescence.mv";
connectAttr "place2dTexture3.s" "PSD_lambert_pumpkin_incandescence.s";
connectAttr "place2dTexture3.wu" "PSD_lambert_pumpkin_incandescence.wu";
connectAttr "place2dTexture3.wv" "PSD_lambert_pumpkin_incandescence.wv";
connectAttr "place2dTexture3.re" "PSD_lambert_pumpkin_incandescence.re";
connectAttr "place2dTexture3.of" "PSD_lambert_pumpkin_incandescence.of";
connectAttr "place2dTexture3.r" "PSD_lambert_pumpkin_incandescence.ro";
connectAttr "place2dTexture3.n" "PSD_lambert_pumpkin_incandescence.n";
connectAttr "place2dTexture3.vt1" "PSD_lambert_pumpkin_incandescence.vt1";
connectAttr "place2dTexture3.vt2" "PSD_lambert_pumpkin_incandescence.vt2";
connectAttr "place2dTexture3.vt3" "PSD_lambert_pumpkin_incandescence.vt3";
connectAttr "place2dTexture3.vc1" "PSD_lambert_pumpkin_incandescence.vc1";
connectAttr "place2dTexture3.o" "PSD_lambert_pumpkin_incandescence.uv";
connectAttr "place2dTexture3.ofs" "PSD_lambert_pumpkin_incandescence.fs";
...
connectAttr "place2dTexture5.c" "PSD_lambert_pumpkin_ambientColor.c";
connectAttr "place2dTexture5.tf" "PSD_lambert_pumpkin_ambientColor.tf";
connectAttr "place2dTexture5.rf" "PSD_lambert_pumpkin_ambientColor.rf";
connectAttr "place2dTexture5.mu" "PSD_lambert_pumpkin_ambientColor.mu";
connectAttr "place2dTexture5.mv" "PSD_lambert_pumpkin_ambientColor.mv";
connectAttr "place2dTexture5.s" "PSD_lambert_pumpkin_ambientColor.s";
connectAttr "place2dTexture5.wu" "PSD_lambert_pumpkin_ambientColor.wu";
connectAttr "place2dTexture5.wv" "PSD_lambert_pumpkin_ambientColor.wv";
connectAttr "place2dTexture5.re" "PSD_lambert_pumpkin_ambientColor.re";
connectAttr "place2dTexture5.of" "PSD_lambert_pumpkin_ambientColor.of";
connectAttr "place2dTexture5.r" "PSD_lambert_pumpkin_ambientColor.ro";
connectAttr "place2dTexture5.n" "PSD_lambert_pumpkin_ambientColor.n";
connectAttr "place2dTexture5.vt1" "PSD_lambert_pumpkin_ambientColor.vt1";
connectAttr "place2dTexture5.vt2" "PSD_lambert_pumpkin_ambientColor.vt2";
connectAttr "place2dTexture5.vt3" "PSD_lambert_pumpkin_ambientColor.vt3";
connectAttr "place2dTexture5.vc1" "PSD_lambert_pumpkin_ambientColor.vc1";
connectAttr "place2dTexture5.o" "PSD_lambert_pumpkin_ambientColor.uv";
connectAttr "place2dTexture5.ofs" "PSD_lambert_pumpkin_ambientColor.fs";
connectAttr "place2dTexture6.c" "PSD_lambert_pumpkin_diffuse.c";
connectAttr "place2dTexture6.tf" "PSD_lambert_pumpkin_diffuse.tf";
connectAttr "place2dTexture6.rf" "PSD_lambert_pumpkin_diffuse.rf";
connectAttr "place2dTexture6.mu" "PSD_lambert_pumpkin_diffuse.mu";
connectAttr "place2dTexture6.mv" "PSD_lambert_pumpkin_diffuse.mv";
connectAttr "place2dTexture6.s" "PSD_lambert_pumpkin_diffuse.s";
connectAttr "place2dTexture6.wu" "PSD_lambert_pumpkin_diffuse.wu";
connectAttr "place2dTexture6.wv" "PSD_lambert_pumpkin_diffuse.wv";
connectAttr "place2dTexture6.re" "PSD_lambert_pumpkin_diffuse.re";
connectAttr "place2dTexture6.of" "PSD_lambert_pumpkin_diffuse.of";
connectAttr "place2dTexture6.r" "PSD_lambert_pumpkin_diffuse.ro";
connectAttr "place2dTexture6.n" "PSD_lambert_pumpkin_diffuse.n";
connectAttr "place2dTexture6.vt1" "PSD_lambert_pumpkin_diffuse.vt1";
connectAttr "place2dTexture6.vt2" "PSD_lambert_pumpkin_diffuse.vt2";
connectAttr "place2dTexture6.vt3" "PSD_lambert_pumpkin_diffuse.vt3";
connectAttr "place2dTexture6.vc1" "PSD_lambert_pumpkin_diffuse.vc1";
connectAttr "place2dTexture6.o" "PSD_lambert_pumpkin_diffuse.uv";
connectAttr "place2dTexture6.ofs" "PSD_lambert_pumpkin_diffuse.fs";
...
connectAttr "PSD_lambert_pumpkin_color.msg" ":defaultTextureList1.tx" -na;
connectAttr "PSD_lambert_pumpkin_transparency.msg" ":defaultTextureList1.tx" -na
		;
connectAttr "PSD_lambert_pumpkin_incandescence.msg" ":defaultTextureList1.tx" -na
		;
connectAttr "PSD_lambert_pumpkin_normalCamera.msg" ":defaultTextureList1.tx" -na
		;
connectAttr "PSD_lambert_pumpkin_ambientColor.msg" ":defaultTextureList1.tx" -na
		;
connectAttr "PSD_lambert_pumpkin_diffuse.msg" ":defaultTextureList1.tx" -na;
